import { initDays } from "./days.js?v=2.4.0";
import { initMonthly } from "./monthly.js?v=2.4.0";
import { initFuel } from "./fuel.js?v=2.4.0";
import { initExpenses } from "./expenses.js?v=2.4.0";
import { initCashflow } from "./cashflow.js?v=2.4.0";
import { VERSION, getReleaseNotes } from "./version.js?v=2.4.0";
import { initSettings } from "./settings.js?v=2.4.0";
